...
#
# Generated by Vivado on Sun Mar 26 14:52:44 CST 2023
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../risc_cpu.gen/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../risc_cpu.gen/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/kafcoppelia/WORK/BOARDS/Genesys2/Very-Simple-RISC-CPU-on-Gen2/proj/risc_cpu.cache/compile_simlib/vcs"
  fi
